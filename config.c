...
struct config_item config_tab[] = {
	...
	PORT_ITEM_INT("hw_tc_fwd", 0, 0, 1),
	PORT_ITEM_STR("hw_tc_delay_file", ""),
	...
	PORT_ITEM_INT("redundancy", 0, 0, 2),
	PORT_ITEM_STR("redundancy_master_interface", NULL),
	PORT_ITEM_INT("redundancy_slave_number", 0, 0, 2),
